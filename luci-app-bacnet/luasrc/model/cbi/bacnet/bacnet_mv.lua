...
--if arg1 then
--	m = Map("bacnet_mv_"..arg1, "Bacnet Multistate Value", "Bacnet Multistate Value Configuration")
--else
m = Map("bacnet_mv", "Bacnet Multistate Value", "Bacnet Multistate Value Configuration")
--end
